...
class Pageviev_men extends StatefulWidget {
  const Pageviev_men({Key? key}) : super(key: key);

  @override
  State< Pageviev_men> createState() =>  Pageviev_menState();
}

class  Pageviev_menState extends State< Pageviev_men> {
  @override
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height:370 ,
              width: 370,
              child: Image.asset("images/image/Screenshot 2024-03-20 010953.png",fit: BoxFit.fill,),
            ),
            SizedBox(height: 15,),
